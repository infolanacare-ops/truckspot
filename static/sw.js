...
const STATIC_CACHE = 'ts-static-v34';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v34';    // API responses
const TILE_CACHE   = 'ts-tiles-v34';   // kafelki mapy
