...
const STATIC_CACHE = 'ts-static-v28';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v28';    // API responses
const TILE_CACHE   = 'ts-tiles-v28';   // kafelki mapy
