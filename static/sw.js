...
const STATIC_CACHE = 'ts-static-v25';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v25';    // API responses
const TILE_CACHE   = 'ts-tiles-v25';   // kafelki mapy
