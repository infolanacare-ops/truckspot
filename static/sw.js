...
const STATIC_CACHE = 'ts-static-v29';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v29';    // API responses
const TILE_CACHE   = 'ts-tiles-v29';   // kafelki mapy
