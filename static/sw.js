...
const STATIC_CACHE = 'ts-static-v41';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v41';    // API responses
const TILE_CACHE   = 'ts-tiles-v41';   // kafelki mapy
