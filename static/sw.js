...
const STATIC_CACHE = 'ts-static-v38';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v38';    // API responses
const TILE_CACHE   = 'ts-tiles-v38';   // kafelki mapy
