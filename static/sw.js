...
const STATIC_CACHE = 'ts-static-v45';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v45';    // API responses
const TILE_CACHE   = 'ts-tiles-v45';   // kafelki mapy
