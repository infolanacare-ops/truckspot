...
const STATIC_CACHE = 'ts-static-v39';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v39';    // API responses
const TILE_CACHE   = 'ts-tiles-v39';   // kafelki mapy
