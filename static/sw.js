...
const STATIC_CACHE = 'ts-static-v24';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v24';    // API responses
const TILE_CACHE   = 'ts-tiles-v24';   // kafelki mapy
