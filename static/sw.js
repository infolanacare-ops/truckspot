...
const STATIC_CACHE = 'ts-static-v40';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v40';    // API responses
const TILE_CACHE   = 'ts-tiles-v40';   // kafelki mapy
