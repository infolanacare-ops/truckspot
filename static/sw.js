...
const STATIC_CACHE = 'ts-static-v44';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v44';    // API responses
const TILE_CACHE   = 'ts-tiles-v44';   // kafelki mapy
