...
const STATIC_CACHE = 'ts-static-v37';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v37';    // API responses
const TILE_CACHE   = 'ts-tiles-v37';   // kafelki mapy
