...
const STATIC_CACHE = 'ts-static-v33';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v33';    // API responses
const TILE_CACHE   = 'ts-tiles-v33';   // kafelki mapy
