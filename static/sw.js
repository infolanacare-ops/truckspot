...
const STATIC_CACHE = 'ts-static-v26';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v26';    // API responses
const TILE_CACHE   = 'ts-tiles-v26';   // kafelki mapy
