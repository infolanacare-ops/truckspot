...
const STATIC_CACHE = 'ts-static-v23';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v23';    // API responses
const TILE_CACHE   = 'ts-tiles-v23';   // kafelki mapy
