...
const STATIC_CACHE = 'ts-static-v27';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v27';    // API responses
const TILE_CACHE   = 'ts-tiles-v27';   // kafelki mapy
