...
const STATIC_CACHE = 'ts-static-v32';  // ikony, manifest (rzadko się zmieniają)
const DATA_CACHE   = 'ts-data-v32';    // API responses
const TILE_CACHE   = 'ts-tiles-v32';   // kafelki mapy
